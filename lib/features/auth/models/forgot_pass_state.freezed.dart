...
class _$_ForgotPassState extends _ForgotPassState {
  ...
  @override
  String toString() {
    return 'ForgotPassState(email: $email, formKey: $formKey, emailLinkResendSecondsLeft: $emailLinkResendSecondsLeft)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, formKey, emailLinkResendSecondsLeft);
...
abstract class _ForgotPassState extends ForgotPassState {
  const factory _ForgotPassState(
      ...
      final int? emailLinkResendSecondsLeft}) = _$_ForgotPassState;
